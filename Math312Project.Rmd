...
The last code chunk runs the app - make sure to load all of the chunks above in order for it to work!
...
```{r eval = FALSE}
# Build the shiny server and lays out how the app will interact with the functions
